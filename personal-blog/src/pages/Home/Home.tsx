      ...
      <div className={`space-y-8 md:space-y-12 lg:space-y-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        ...
        <div className={`flex flex-col lg:flex-row items-center lg:items-start gap-6 md:gap-8 lg:gap-12 transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          ...
          <div className="flex-1 text-center lg:text-left order-1 lg:order-2">
            <h1 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 md:mb-4 leading-tight transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
              Hi, I'm <span className="text-blue-600 animate-pulse">Your Name</span>
            </h1>
            <h2 className={`text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-gray-700 mb-3 md:mb-4 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
              Full-Stack Developer & Software Engineer
            </h2>
            <p className={`text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto lg:mx-0 leading-relaxed mb-4 md:mb-6 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}>
        ...
        <div className={`bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-4 md:p-6 lg:p-8 shadow-sm transition-all duration-700 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div
                key={skill.title}
                className={`bg-white rounded-xl p-4 md:p-6 shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 border-l-4 border-${skill.color}-500 group ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
        ...
        <div className={`bg-white rounded-xl p-4 md:p-6 lg:p-8 shadow-lg border border-gray-100 transition-all duration-700 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}>
