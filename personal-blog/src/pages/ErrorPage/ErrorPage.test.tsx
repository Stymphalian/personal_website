...
describe('ErrorPage', () => {
  ...
  describe('Error Types', () => {
    ...
    it('renders content-error correctly', () => {
      ...
      expect(
        screen.getByText('There was a problem loading the requested content.')
      ).toBeInTheDocument();
      expect(screen.getByText('📄')).toBeInTheDocument();
    });
    ...
    it('renders malformed-content error correctly', () => {
      ...
      expect(
        screen.getByText('The requested content has formatting issues.')
      ).toBeInTheDocument();
  ...
  describe('Custom Error Messages', () => {
    it('renders custom title and message', () => {
      renderWithRouter(
        <ErrorPage title='Custom Error Title' message='Custom error message' />
      );
