...
const Headshot: React.FC<HeadshotProps> = ({
  ...
  return (
    <div className={`relative ${sizeClasses[size]} ${className}`}>
      ...
      <div
        className={`absolute inset-0 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center shadow-lg transition-opacity duration-300 ${
