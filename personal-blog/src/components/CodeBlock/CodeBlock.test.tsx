...
line3`;
      ...
      const lineNumberOverlay = screen
        .getByText('1')
  ...
  describe('Theme Support', () => {
    ...
    it('applies correct header theme classes', () => {
      ...
      const header = screen
        ...
        .closest('div[class*="bg-vs-editor-surface2"]');
      expect(header).toHaveClass(
        'bg-vs-editor-surface2',
        'border-vs-editor-border'
      );
    });
  });
  ...
  return \`Hello, \${name}!\`;
      ...
      expect(
        screen.getByText(/return `Hello, \${name}!`;/)
      ).toBeInTheDocument();
  ...
  describe('Accessibility', () => {
    ...
    it('uses semantic HTML structure', () => {
      ...
      expect(screen.getByText(/console\.log\("Hello, World!"\);/).tagName).toBe(
        'CODE'
      );
    });
  });
