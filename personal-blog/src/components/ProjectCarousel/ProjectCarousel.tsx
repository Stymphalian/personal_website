    ...
    >
      ...
      <div className='relative bg-vs-editor-surface rounded-xl overflow-hidden shadow-lg border border-vs-editor-border'>
        ...
        <div className='px-6 py-4 bg-vs-editor-surface border-b border-vs-editor-border'>
          ...
          <p className='text-lg text-vs-editor-text2 px-4 py-2 bg-vs-editor-surface2/80 backdrop-blur-sm rounded-lg border border-vs-editor-border'>
        ...
        {/* Project Description */}
        <div className='p-6'>
          <p className='text-vs-editor-text2 leading-relaxed'>
